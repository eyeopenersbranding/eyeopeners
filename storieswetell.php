  ...
  <head>
    ...
    <div id="home">
        ...
        <div class="container items">
            <div class="col-md-6">
                <img class="img-responsive picsGall" src="images/prettyPhotoImages/111/pic5.jpg"/>
            </div>
            <div class="col-md-6">
                <p>
                    Stories We Tell is een online magazine voor 50/60 plus vrouwen. Stories We Tell maakt gebruik van een geweldig platform "instant magazine". 
					Hierdoor worden verhalen op een levendige en creatieve manier gepresenteerd.<br />
					Voor Stories We Tell mochten wij het logo ontwerpen. Wij wensen Stories We Tell veel onlines succes!
                </p>
            </div>        
        </div>
